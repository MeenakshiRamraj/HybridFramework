...
public class GiftUI {
    ...
    public By housewarming=By.xpath("//*[@id='app-container']/div/main/section/section[1]/ul/li[2]");
    public By birthday=By.xpath("//*[@id='app-container']/div/main/section/section[1]/ul/li[3]");
    public By specialOccasion=By.xpath("//*[@id='app-container']/div/main/section/section[1]/ul/li[4]");
    public By corporategift=By.xpath("//*[@id='app-container']/div/main/section/section[1]/ul/li[5]");
    public By othergifts=By.xpath("//*[@id='app-container']/div/main/section/section[1]/ul/li[6]");
